      ...
      <div className='flex'>
        <div className='min-w-2xl rounded-2xl overflow-hidden'>
          ...
          <div className='px-5 flex flex-col space-y-5 '>
              <h5 className='text-center text-yellow-600 font-bold text-3xl w-1/2 mx-auto '>{data.subTitle}</h5>
              <p className='text-justify font-bold text-lg text-description'>{data.description}</p>
