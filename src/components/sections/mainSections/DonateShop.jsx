...
export default function DonateShop( { data } ) {
  return (
    <div id='donate' className="flex flex-col gap-y-10 p-6 bg-gray-100 shadow-black rounded-2xl shadow-lg">
      ...
      <div className='grid xl:grid-cols-3 grid-cols-1 gap-20 mx-auto '>
