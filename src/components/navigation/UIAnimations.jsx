...
export default function UIAnimations({ data }) {
  ...
  return (
    <div className="bg-gray-700 flex overflow-hidden h-24 shadow-lg  shadow-black relative items-center w-full">
      <div className="absolute w-full left-0">
        {data.link.map((elem, index) => (
          <a
            ...
            className={`${elem.item} ${elem.color}  border-2 rounded-full px-3 py-2 
